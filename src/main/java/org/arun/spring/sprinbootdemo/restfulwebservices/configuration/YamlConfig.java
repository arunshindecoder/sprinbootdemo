...
public class YamlConfig {
    ...
    @Value("#{'${cors-allowed-list-arun}'.split(',')}")
    private List<String> corsAllowedListOne = new ArrayList<>();
    ...
    public String toString() {
        return "YamlConfig{" +
                "name='" + name + '\'' +
                ", aliases=" + aliases +
                ", publicApiList=" + publicApiList +
                ", corsAllowedList=" + corsAllowedList +
                ", corsAllowedListOne=" + corsAllowedListOne +
                '}';
    }
}
